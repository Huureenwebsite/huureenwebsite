...
import { portfolioHeroImage } from "@/lib/concept-showcases";
    ...
    <div className="portfolio-page">
      <section className="portfolio-hero">
        ...
        <div className="container portfolio-hero-inner">
          <p className="portfolio-kicker">Concept-showcases · Signature scroll-film</p>
          ...
          <div className="hero-cta">
            <Link href="#concepten" className="btn btn-primary">
              Bekijk de 4 concepten <ArrowRight size={17} />
            </Link>
      ...
      <section className="concept-showcases-section" id="concepten">
        <div className="container">
          <div className="portfolio-section-head">
            <div>
              <p className="portfolio-kicker">Vier signature showcases</p>
              <h2>Vier niches. Eén regieprincipe.</h2>
            </div>
            <p>
      ...
      <section className="client-work-section">
        <div className="container">
          <div className="portfolio-section-head is-light">
            <div>
              <p className="portfolio-kicker is-dark">Daarnaast: echt klantwerk</p>
          ...
          <div className="client-work-grid">
            {echteCases.map((clientCase) => (
              <article className="client-work-item" key={clientCase.slug} data-reveal>
